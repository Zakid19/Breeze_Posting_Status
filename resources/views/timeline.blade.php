    ...
    <x-container>
        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="w-full">
                                ...
                                <div class="mb-y">
                                    <textarea
                                        name="body"
                                        id="body"
                                        placeholder="" class="form-textarea w-full border-gray-300 rounded-xl resize-none focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200" >
                                    </textarea>
                                </div>
            ...
            <div class="col-span-5">
                <x-card>
                    <h1 class="font-semibold mb-5">Recenly Follows</h1>
                    <div class="space-y-5">
